...
from nuxt.asyncio.proxies.streams import read_stream_in_chunks
...
async def get_proxy_response(*, context: ProxyContext, scope: Scope, receive: Receive,) -> aiohttp.ClientResponse:
...
async def convert_proxy_response_to_user_response(*, context: ProxyContext, scope: Scope, proxy_response: aiohttp.ClientResponse) -> Response:
...
async def proxy_http(*, context: ProxyContext, scope: Scope, receive: Receive, send: Send) -> None:
